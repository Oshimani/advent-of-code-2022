...
def check_overlaps(assignments: list):
    ...
    # check if assignment 1 is between assignment 2
    if assignment_1[0] >= assignment_2[0] and assignment_1[1] <= assignment_2[1]:
        return True
    # check if assignment 2 is between assignment 1
    if assignment_2[0] >= assignment_1[0] and assignment_2[1] <= assignment_1[1]:
        return True
    return False
